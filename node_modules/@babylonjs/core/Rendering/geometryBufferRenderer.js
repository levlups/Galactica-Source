    ...
    GeometryBufferRenderer.prototype._createRenderTargets = function () {
        ...
        var renderSubMesh = function (subMesh) {
            ...
            if (_this.isReady(subMesh, hardwareInstancedRendering)) {
                ...
                // Draw
                renderingMesh._processRendering(effectiveMesh, subMesh, _this._effect, material.fillMode, batch, hardwareInstancedRendering, function (isInstance, w) { return _this._effect.setMatrix("world", w); });
            }
            // Velocity
            if (_this._enableVelocity) {
