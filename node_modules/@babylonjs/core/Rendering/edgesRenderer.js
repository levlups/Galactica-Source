...
var EdgesRenderer = /** @class */ (function () {
    ...
    EdgesRenderer.prototype._generateEdgesLinesAlternate = function () {
        ...
        if ((_g = this._options) === null || _g === void 0 ? void 0 : _g.applyTessellation) {
            ...
            for (var index = 0; index < indices.length; index += 3) { // loop over all triangles
                var triangleToTessellate = void 0;
                for (var i = 0; i < 3; ++i) { // loop over the 3 edges of the triangle
                    ...
                    for (var v = 0; v < uniquePositions.length - 1; v++) { // loop over all (unique) vertices and look for the ones that would be in-between p0 and p1
