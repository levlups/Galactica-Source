    ...
    BasisTools.TranscodeAsync = function (data, config) {
        ...
        return new Promise(function (res, rej) {
            _this._CreateWorkerAsync().then(function () {
                ...
                _this._Worker.postMessage({ action: "transcode", id: actionId, imageData: dataViewCopy, config: config, ignoreSupportedFormats: _this._IgnoreSupportedFormats }, [dataViewCopy.buffer]);
            });
        });
    };
    /**
