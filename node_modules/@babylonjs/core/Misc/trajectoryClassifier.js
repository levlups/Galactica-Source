...
(function (Levenshtein) {
    ...
    var Sequence = /** @class */ (function () {
        ...
        Sequence._costMatrix = __spreadArrays(Array(Sequence.MAX_SEQUENCE_LENGTH + 1)).map(function (n) { return new Array(Sequence.MAX_SEQUENCE_LENGTH + 1); });
        return Sequence;
    }());
...
var TrajectoryDescriptor = /** @class */ (function () {
    ...
    TrajectoryDescriptor.Deserialize = function (json, alphabet) {
        ...
        descriptor._sequences =
            JSON.parse(json).map(function (s) { return Levenshtein.Sequence.Deserialize(s, alphabet); });
        return descriptor;
    };
    /**
    ...
    TrajectoryDescriptor._getTokenizationPyramid = function (trajectory, alphabet, targetResolution) {
        if (targetResolution === void 0) { targetResolution = TrajectoryDescriptor.FINEST_DESCRIPTOR_RESOLUTION; }
        var pyramid = [];
