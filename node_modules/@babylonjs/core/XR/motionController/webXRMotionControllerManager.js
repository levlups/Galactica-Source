    ...
    WebXRMotionControllerManager._LoadProfileFromRepository = function (profileArray, xrInput, scene) {
        ...
        return Promise.resolve()
            ...
            if (!_this._ProfileLoadingPromises[profileToLoad]) {
                _this._ProfileLoadingPromises[profileToLoad] = Tools.LoadFileAsync(_this.BaseRepositoryUrl + "/profiles/" + profileToLoad + "/profile.json", false).then(function (data) { return JSON.parse(data); });
            }
