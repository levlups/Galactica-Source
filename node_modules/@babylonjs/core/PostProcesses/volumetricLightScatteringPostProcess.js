    ...
    VolumetricLightScatteringPostProcess.prototype._createPass = function (scene, ratio) {
        ...
        var renderSubMesh = function (subMesh) {
            ...
            if (_this._isReady(subMesh, hardwareInstancedRendering)) {
                ...
                // Draw
                renderingMesh._processRendering(effectiveMesh, subMesh, _this._volumetricLightScatteringPass, Material.TriangleFillMode, batch, hardwareInstancedRendering, function (isInstance, world) { return effect.setMatrix("world", world); });
            }
        };
