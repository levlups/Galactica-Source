...
export declare class SceneComponentConstants {
    ...
    static readonly STEP_BEFORECAMERADRAW_PREPASS = 2;
    ...
    static readonly STEP_AFTERCAMERADRAW_PREPASS = 4;
    ...
    static readonly STEP_BEFORECLEARSTAGE_PREPASS = 0;
 ...
 */
export declare type RenderingMeshStageAction = (mesh: Mesh, subMesh: SubMesh, batch: _InstancesBatch, effect: Nullable<Effect>) => void;
/**
