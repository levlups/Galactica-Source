...
function Registry(noa, opts) {
	...
	this.getBlockLight= function (id) {
        return blockLight[id]
    }
	
	this.setBlockLight= function (id,value) {
      blockLight[id]=value
    }
	...
	// setting new color
	this.setMaterialColor = function (matID,value) {
       matData[matID].color=value
    }
    ...
    this.getMaterialTexture = function (matID) {
	 ...
	 this.setMaterialTexture = function (matID,value) {
        matData[matID].texture=value
    }
