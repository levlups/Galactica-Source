...
function Entities(noa, opts) {
    ...
    // misc
	this.getFollowsData=this.getStateAccessor(this.names.followsEntity)
...
Entities.prototype.addent = function (position, width, height, // required
    mesh, meshOffset, doPhysics, shadow) {
    ...
    if (mesh) {
        if (!meshOffset) meshOffset = vec3.create()
        this.addComponent(eid, this.names.entmesh, {
            mesh: mesh,
            offset: meshOffset
        })
    }
