...
World.prototype.setBlockID = function (val, x, y, z) {
	...
	///added this levelups//////////////////
         if(lol){
		 this._updateChunkAndBorders(this, i, j, k, this.chunkSize, ix, iy, iz, val)
		 }
		 //////////
}

///added these two levlups///////////////////
World.prototype._updateChunkAndBorders=function(world, i, j, k, size, x, y, z, val) {
    var ilocs = [0]
    var jlocs = [0]
    var klocs = [0]
...
World.prototype._modifyBlockData=function(world, i, j, k, x, y, z, val) {
    var chunk = this._getChunk( i, j, k)
    if (!chunk) return
    chunk.set(x, y, z, val)
