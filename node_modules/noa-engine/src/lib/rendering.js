...
function initScene(self, canvas, opts) {
    ...
    self._camScreen = Mesh.CreatePlane('camScreen', 0.5, scene)
        ...
        if (matId) {
            ...
            if (col && alpha && alpha < 1) {
               ...
               self._camScreenMat.ambientColor.set(col[0], col[1], col[2])
				...
				//self._camScreenMat.diffuseTexture=new BABYLON.Texture("./textures/block/water_overlay.png", scene, true, true, BABYLON.Texture.NEAREST_SAMPLINGMODE);
...
function getHighlightMesh(rendering) {
    ...
    if (!mesh) {
		...
		//mesh = Mesh.CreateBox("highlight", 1.0, rendering._scene)//Mesh.CreatePlane("highlight", 1.0, rendering._scene)
