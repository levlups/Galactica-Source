...
function applyMovementPhysics(dt, state, body) {
	...
	//if(state.isFlying) ? ((body.gravityMultiplier = 0), (body.airDrag = 2),body.applyForce([0, 2 * 12, 0])) : ((body.gravityMultiplier = 2), (body.airDrag = 0.1));
	
	state.isFlying ? ((body.gravityMultiplier = 0), (body.airDrag = 2)) : ((body.gravityMultiplier = 2), (body.airDrag = 0.1));
	
	
if(!state.isFlying){
state.onLadder ? ((body.gravityMultiplier = 0), (body.airDrag = 2)) : ((body.gravityMultiplier = 2), (body.airDrag = 0.1));
}
...
//state.onLadder ? (body.gravityMultiplier = 0) : (body.gravityMultiplier = 1);
