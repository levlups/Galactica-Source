    ...
    return {
        ...
        onAdd: function (eid, state) {
			...
			state.height=0.5-0.9
							...
							noa.rendering.addMeshToScene(state.bow,false)
							noa.rendering.addMeshToScene(state.bow._children[0],false)
							noa.rendering.addMeshToScene(state.bow._children[1],false)
							
							state.bow.rotation.y=-Math.PI/2
							state.bow.position.x=state.mesh._children[2].position.x+0.25
							state.bow.position.y=state.mesh._children[2].position.y-1.2
							state.bow.position.z=state.mesh._children[2].position.z-0.7
						state.bow.parent=state.mesh._children[2]
        ...
        renderSystem: function (dt, states) {
			...
			if(state.dist>5&& state.dist<30 /*&& state.body.resting[1]<0*/){
				state.headcool=0;
				...
				//state.mesh._children[2].rotation.x=1*Math.PI/8+Math.sin(state.walkcycle*0.08)*1.5
					noa.ents.getState(id, noa.entities.names.stats).walking='zombiearcher'
