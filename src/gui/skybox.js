...
export function setupClouds(noa) {
	...
	var cloudTexture = new BABYLON.Texture(mod+'textures/environment/clouds.png', scene, true, true, BABYLON.Texture.NEAREST_SAMPLINGMODE);
	...
	noa.on('beforeRender', function() {
		...
		cloudMat.diffuseTexture.vOffset += 0.00001 
		cloudMat.diffuseTexture.uOffset -= 0.00001
