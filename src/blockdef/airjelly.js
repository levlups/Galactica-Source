...
import { spawnEnt } from '../spawner'
	var bedjsony=null
export function makeairjelly(noa,options,id,name,e){
	
	bedjsony=e
	
		var bustex = new BABYLON.Texture(mod+"models/airjelly/airjelly.png", scene, false, true, BABYLON.Texture.NEAREST_SAMPLINGMODE);
...
bustex.hasAlpha=true;
						...
						BABYLON.SceneLoader.ImportMesh("", "",mod+ "models/airjelly/airjelly.babylon", scene, function (meshes) { 
