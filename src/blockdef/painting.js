...
var doorjson=null
export function makepainting(noa,options,id,texture,name,e){
	
		doorjson=e
	
			//var supermesh=BABYLON.Mesh.CreatePlane(name,1, scene)
			var supermesh=BABYLON.Mesh.CreatePlane(name,4, scene)
			...
			var offset = BABYLON.Matrix.Translation(0, 2, 0)
