export function waterside(noa,options,id){
...
//32
     ...
     bustex.vOffset += 1/16;
			...
			BABYLON.SceneLoader.ImportMesh("", "", mod+"models/cube/waterside.babylon", scene, function (meshes) { 
	        ...
	        meshes[0].bakeTransformIntoVertices(offset)
				...
				o=noa.getBlock(x-1,y,z);
							...
							if(c==blockIDs['waterside1']){
								  //if(blocks[c].type==1){
									  noa.setBlock(0,[x,y,z+1])
								  //}
							}
							
							if(n==blockIDs['waterside1']){
								 // if(blocks[n].type==1){
									  noa.setBlock(0,[x,y,z-1])
								  //}
							}
							
							if(a==blockIDs['waterside1']){
								  //if(blocks[a].type==1){
									  noa.setBlock(0,[x+1,y,z])
								  //}
							}
							if(o==blockIDs['waterside1']){
								//  if(blocks[o].type==1){
									  noa.setBlock(0,[x-1,y,z])
								  //}
							}
                  ...
                  if(noa.getBlock(x,y,z-1)==0){
					   noa.setBlock(blockIDs['waterside1'],[x,y,z-1])
				  }
				  ...
				  if(noa.getBlock(x+1,y,z)==0){
					  noa.setBlock(blockIDs['waterside1'],[x+1,y,z])
				  }
				 ...
				 if(noa.getBlock(x,y,z-1)==blockIDs['watersource']){
				 ...
				 if(noa.getBlock(x+1,y,z)==blockIDs['watersource']){
