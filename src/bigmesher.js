module.exports.make3d =function(name){
	var mesharrays=[];
	var colors;
	...
	//var scene=noa.rendering.getScene();
		...
		imaga.id=name.name
		imaga.src=mod+"textures/"+name.texture+".png";
		console.log(imaga)
		console.log(mod+"textures/"+name.texture+".png")
				var mat = new BABYLON.StandardMaterial("mat", scene,false, true, BABYLON.Texture.NEAREST_SAMPLINGMODE);
				objectContext.drawImage(document.getElementById(name.name),0,0,16,16);
...
projectiles[name.name]=supermesh;
	return supermesh;
