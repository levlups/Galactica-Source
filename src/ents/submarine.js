...
var scene=null
var modelname='cow'
export function defineModelCompSubmarine(noa2) {
	noa = noa2
scene=noa.rendering.getScene()
	
	
		
		var bustex = new BABYLON.Texture(mod+"models/submarine/submarine.png", scene, false, true, BABYLON.Texture.NEAREST_SAMPLINGMODE);
...
BABYLON.SceneLoader.ImportMesh("", "", mod+"models/submarine/submarine.babylon", scene, function (meshes) { 
...
for (var i=0;i<meshes.length;i++){
 ...
 meshbody.scaling.y=3
  meshbody.scaling.x=3
   meshbody.scaling.z=3
...
export  function applyModelSubmarine(eid, model, texture, offset, nametag, name, hitbox,randomizer,rando,entityList,uuid,socket,PF) {
