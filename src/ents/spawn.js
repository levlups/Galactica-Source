...
var name='sign'
var num=0
export function defineModelCompSpawn(noa2) {
		noa = noa2
...
dogmat.specularColor = BABYLON.Color3.Red()
...
export  function applyModelSpawn(eid, model, texture, offseta, nametag, name, hitbox,entityList,uuid,socket,chest,datrotation) {
	...
	num+=1
		...
		var k=noa.ents.getState(eid, 'position').position
		teamcoords[num]=[k[0],k[1],k[2]]
